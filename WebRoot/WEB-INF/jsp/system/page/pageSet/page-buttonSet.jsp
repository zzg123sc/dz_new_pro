...
<body layadmin-themealias="default">
  ...
  <div class="layui-form">
  	<div class="layui-btn-container" align="center">
  		<span class='drage'><button type='button' class="layui-btn" buttonType='1'><span id='btnName' name='btnName'>添加</></button></span>
  		<span class='drage'><button type='button' class="layui-btn" buttonType='2'><span id='btnName' name='btnName'>批量修改</></button></span>
  		<span class='drage'><button type='button' class="layui-btn" buttonType='3'><span id='btnName' name='btnName'>批量删除</></button></span>
  		<span class='drage'><button type='button' class="layui-btn" buttonType='4'><span id='btnName' name='btnName'>导入</></button></span>
  		<span class='drage'><button type='button' class="layui-btn" buttonType='5'><span id='btnName' name='btnName'>导出</></button></span>
  		<span class='drage'><button type='button' class="layui-btn" buttonType='6'><span id='btnName' name='btnName'>自定义</></button></span>
  	</div>
...
<script>
    ...
    //初始化设置数据
    inintButtonTable ($("#buttonSetTable"),${buttonSet}); 
  	//按钮设置初始化
