...
import com.mbfw.plugin.websocketInstantMsg.ChatServer;
import com.mbfw.plugin.websocketOnline.OnlineChatServer;
import com.mbfw.util.Const;
import com.mbfw.util.Tools;

/**
 * 创建人：研发中心 创建时间：2014年2月17日
 * 
 * @version
 */
	...
	public void startWebsocketInstantMsg() {
		...
		try {
			...
			if (null != strWEBSOCKET && !"".equals(strWEBSOCKET)) {
				String strIW[] = strWEBSOCKET.split(",mbfw,");
				if (strIW.length == 4) {
